...
find_path(INCLUDE_DIR grpc_client.h HINTS ${TRITON_CLIENT_DIR}/include)
list(APPEND INCLUDE_DIRS ${INCLUDE_DIR})

# find libraries
find_library(GrpcLib libgrpcclient.so HINTS ${TRITON_CLIENT_DIR}/lib)
find_library(HttpLib libhttpclient.so HINTS ${TRITON_CLIENT_DIR}/lib)
find_library(ProtobufLib libprotobuf.a HINTS ${TRITON_CLIENT_DIR}/lib)
find_library(ProtobufLiteLib libprotobuf-lite.a HINTS ${TRITON_CLIENT_DIR}/lib)
